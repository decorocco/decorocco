...
![SQLAlchemy](https://img.shields.io/badge/-SQLAlchemy-d91b2c?style=flat-square&logo=sqlalchemy&logoColor=white)
...
### Currently developing a flowchart programming app in C# and C++
  - Implemented improvements and optimizations to the app, focusing on performance and maintainability.
  - Integrating new development boards to a client app for ease of use;
  - Refactored legacy C and C++ code to modern standards, improving readability and reliability across modules.
  - Worked with C++, C#, HTML and Python, ensuring seamless integration between different modules and languages.
...
<div align="center">
  ...
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=decorocco&layout=compact&langs_count=8&theme=tokyonight"/>
</div>
